...
import com.buncua.movies.dto.ReqRes;
import com.buncua.movies.config.JWTAuthFilter;
import com.buncua.movies.models.MyUsers;
import com.buncua.movies.repository.UsersRepo;
...
public class UsersManagementService {
    ...
    public ReqRes register(ReqRes registrationRequest){
        ...
        try {
            ...
            myUsers.setEmail(registrationRequest.getEmail());
            myUsers.setRole(registrationRequest.getRole());
            myUsers.setName(registrationRequest.getName());
            myUsers.setPassword(passwordEncoder.encode(registrationRequest.getPassword()));
            MyUsers myUsersResult = usersRepo.save(myUsers);
    ...
    public ReqRes refreshToken(ReqRes refreshTokenReqiest){
        ...
        try{
            String myEmail = jwtUtils.extractUsername(refreshTokenReqiest.getToken());
    ...
    public ReqRes getUsersById(Integer id) {
        ReqRes reqRes = new ReqRes();
        try {
            MyUsers usersById = usersRepo.findById(id).orElseThrow(() -> new RuntimeException("User Not found"));
